...
process_orders(LevelPriceType compPrice, Order &order,
               PriceLevels &mPriceLevels, OrderLevels &mOrderLevels,
               Volumes &volumes, OrderStore &orders, OrderBitSet &ordersActive,
               PriceLevels &sPriceLevels, OrderLevels &sOrderLevels) noexcept {
